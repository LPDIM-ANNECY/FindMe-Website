 ...
 */
final class Version20210416202516 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE public."user" (id INT NOT NULL, chief_id INT DEFAULT NULL, email VARCHAR(180) DEFAULT NULL, company_name VARCHAR(180) DEFAULT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, email VARCHAR(180) DEFAULT NULL, company_name VARCHAR(180) DEFAULT NULL, create_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, roles JSON NOT NULL, password VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))');
